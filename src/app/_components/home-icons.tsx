import type {
  CommunityBenefitIconName,
  SpecialtyIconName,
} from "@/app/_data/home-content";
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 16v0"
      />
    </svg>
  );
}
...
export function CommunityBenefitIcon({
  icon,
  className,
}: {
